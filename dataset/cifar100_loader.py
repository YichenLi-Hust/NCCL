...
def load_cifar100(client_num_in_total, alpha, batch_size, maximun):
    class_num = 100
    n = 10
    ...
    trainset = datasets.CIFAR100(root='/Dataset/CIFAR100', train=True,
                                            download=True, transform=train_transform)
    trainloader = torch.utils.data.DataLoader(trainset, batch_size=len(trainset),
                                            shuffle=False, num_workers=2)


    testset = datasets.CIFAR100(root='/Dataset/CIFAR100', train=False,
